class RecipesController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @recipe.update(recipe_params)
        format.html { redirect_to recipes_path(@recipe), notice: 'Recipe was successfully updated.' }
  ...
  def recipe_params
    params.require(:recipe).permit(:name, :preparation_time, :cooking_time, :description, :cooking_steps, :public,
                                   :user_id)
  end
end
